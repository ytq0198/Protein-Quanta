...
- [x] **Step 3: Implement the minimal CLI extension**
...
- [x] **Step 4: Verify Task 2 and full regression suite**
...
- [x] **Step 1: Run validation replay with the frozen mapping**
...
- [x] **Step 2: Check validation protocol and guards before touching test**
...
- [x] **Step 3: Run the frozen internal test exactly once**
...
- [x] **Step 4: Apply the preregistered promotion rules**
...
- [x] **Step 5: Create the comparison figure and research record**
...
- [x] **Step 6: Update the living reports and frozen manifest conditionally**
...
- [x] **Step 7: Verify release and commit**
