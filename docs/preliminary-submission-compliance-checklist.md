...
| 优先级 | 风险 | 当前证据 | 关闭条件 |
|---|---|---|---|
| P0 | 官方提交入口、具体截止时刻、文件格式/大小未知 | 官网与手册均确认 8 月 16 日，但公开页面未写具体时刻；方向二教程摘要确认最多提交 3 次且以最后一次为准 | 魏子安人工登录参赛账号截图/记录入口、时刻、文件限制；若与手册冲突，立即更新本清单 |
...
- [ ] 已从官方最新渠道确认截止时刻、入口、文件类型、大小、命名规范和是否需要 PDF/PPT。
