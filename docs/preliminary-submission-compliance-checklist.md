...
> 依据：`AI for research指导手册.pdf` 第 4、8-13、18-21、25-27 页，以及算法赛初赛模板。指导手册自称“规划版本”，如官网/群公告有更新，以组委会最新通知为准。

## 1. 已重新核实的硬规则

- 初赛截止：指导手册第 4 页写明 **8 月 16 日**；手册没有给出具体时刻，必须由人工从官网/群公告复核。
- 晋级：第 4 页写明初赛评审后 **Top 40** 进入复赛；复赛后 Top 20 进入线下决赛。
...
| 优先级 | 风险 | 当前证据 | 关闭条件 |
|---|---|---|---|
| P0 | 官方提交入口、具体截止时刻、文件格式/大小未知 | 指导手册只给日期，且声明以最新通知为准 | 魏子安人工登录官方渠道截图/记录最新通知；若与手册冲突，立即更新本清单 |
